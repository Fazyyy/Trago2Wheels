        ...
        <div className="bikeContainer">
          <div className="row">
            <div className="col-sm-6">
              <Img fluid={post.mainImage.childImageSharp.fluid} />
            </div>
            <div className="col-sm-6">
              <h2>{post.title}</h2>
              <div
              ...
              <ul className="bikeInfo">
                <li>
                  Weight <span>{post.weight}kg</span>
                </li>
                <li>
                  Engine <span>{post.Engine}</span>
                </li>
                <li>
                  Displacement <span>{post.displacement}cc</span>
                </li>
                <li>
                  Max Power <span>{post.maxpower}bhp</span>
                </li>
                <li>
                  Transmission <span>{post.transmission}</span>
                </li>
                <li>
                  Fuel Tank <span>{post.fueltank} Litres</span>
                </li>
              </ul>
              <p
                style={{
              ...
              <div className="container-fluid discountDisp">
