  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content="Trago2Wheels is the leading supplier of motorbikes, scooters and accessories in South Wales and the South West."
        />
        <link
      ...
      <div className="container-fluid rideoutHome">
        <div className="container">
                ...
                <div className="event-item">
                  ...
                  <div style={{ padding: "15px" }}>
                    <p style={{ textAlign: "right" }}>
                      ...
                      {node.frontmatter.ezDate}
                    </p>
                    <p>{node.excerpt}</p>
                    <p style={{ float: "right" }}>
                      <Link className="eventLink" to={node.fields.slug}>
                        View
                      </Link>
                    </p>
                  </div>
          ...
          <div className="row" style={{ marginTop: "50px" }}>
            <div className="col">
              <p style={{ float: "right" }}>
                <Link className="eventLink big" to="/events/">
                  View All
                </Link>
              </p>
            </div>
...
export const eventQuery = graphql`
  query eventsQuery {
    allMarkdownRemark(
      limit: 3
      filter: { frontmatter: { product: { regex: "/event/" } } }
